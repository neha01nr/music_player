...
<head>
    ...
    <title>Simple Music Player App</title> <!-- Set the page title -->
    <link rel="stylesheet" href="./font-awesome/css/all.min.css"> <!-- Include Font Awesome CSS -->
    ...
    <script src="./font-awesome/js/all.min.js"></script> <!-- Include Font Awesome JavaScript -->
    <script src="./js/jquery-3.6.0.min.js"></script> <!-- Include jQuery -->
    <script src="./js/popper.min.js"></script> <!-- Include Popper.js -->
    <script src="./js/bootstrap.min.js"></script> <!-- Include Bootstrap JavaScript -->
    <script src="./js/script.js"></script> <!-- Include custom JavaScript -->
</head>

<body class="text-light bg-dark bg-gradient">
    <script>
        start_loader(); // Start a loader (assuming this function is defined elsewhere)
    </script>
    <main>
        <div class="col-lg-12">
        ...
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <form action="" id="music-form">
                            <!-- Hidden input for the music ID -->
                            <input type="hidden" name="id">
                            <div class="form-group mb-3">
                                <label for="title" class="control-label">Title</label>
                                <!-- Input field for music title -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <!-- Textarea for music description -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <!-- Input field for music audio file -->
                            ...
                            <div class="form-group mb-3 text-center">
                                <div class="col-md-6">
                                    <!-- Display current image or a default image -->
                ...
                <div class="modal-footer">
                    <!-- Submit and close buttons for adding new music -->
    ...
    <div class="modal text-dark" id="update_music_modal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-footer">
                    <!-- Submit and close buttons for updating music data -->
...
<?php
// Close the database connection if it's set and not null
if (isset($conn) && $conn) {
    @$conn->close();
}
?>
